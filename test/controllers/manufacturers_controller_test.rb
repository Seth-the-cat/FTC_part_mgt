...
class ManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufacturer" do
    assert_difference("Manufacturer.count") do
      post manufacturers_url, params: { manufacturer: { manufacturer_name: @manufacturer.manufacturer_name, website: @manufacturer.website } }
    end
  ...
  test "should update manufacturer" do
    patch manufacturer_url(@manufacturer), params: { manufacturer: { manufacturer_name: @manufacturer.manufacturer_name, website: @manufacturer.website } }
