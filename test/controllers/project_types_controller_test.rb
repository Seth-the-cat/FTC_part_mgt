...
class ProjectTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_type" do
    assert_difference("ProjectType.count") do
      post project_types_url, params: { project_type: { description: @project_type.description, project_type_name: @project_type.project_type_name } }
    end
  ...
  test "should update project_type" do
    patch project_type_url(@project_type), params: { project_type: { description: @project_type.description, project_type_name: @project_type.project_type_name } }
